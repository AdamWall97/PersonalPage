  ...
  */
    ...
    <div className="w-75 m-auto">
        ...
        <div className="row p-2">
            ...
            <div className="col-lg">
                <SkillCard title="SQL" rating={3.5} text="2 years of experience maintaining enterprise lab request system and designing relational tables for lab applications"  />
            </div>
        </div>
        <div className="row p-2">
        <div className="col-lg">
            <SkillCard title="Visual Basic" rating={2} text="3 years of experience creating test lab scripts for lab automation and created rich excel spreadsheets to perform lab analysis"/>
        </div>
        <div className="col-lg">
            <SkillCard title="4D" rating={2} text="6 months of experience redesigning and fixing bugs on existing enterprise resource planning system"  />
        </div>
        <div className="col-lg">
            <SkillCard title="HTML / CSS" rating={3.5} text="2 years of experience creating functional web applications in a wide vareity of frameworks"  />
        </div>
        </div>
